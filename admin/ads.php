...
<h3><a href="<?=$PHP_SELF?>">No</a>&nbsp;<a href="<?=$PHP_SELF?>?delete2=<?=$delete?>">Yes</a></h3>
<? } elseif(isset($new)) { ?>
<form action="<?=$PHP_SELF;?>" method="post">
...
<?
  ...
  WHILE($row = sql_fetch_row($queryres)) {
	...
	.'<TD bgcolor="#eeffee">'.$row[1]
       	...
       	.'</TD><TD bgcolor="#eeeeee" align="center"><a href="'.$PHP_SELF.'?delete='.$row[6].'"><img src="../img/delete.gif" border="0" alt="Delete"></a>&nbsp;'
	.'<a href="'.$PHP_SELF.'?id='.$row[6].'"><img src="../img/edit.gif" border="0" alt="Edit"></a>'
       	."</TD></TR>\n");
  } 
?>
</TABLE>
<br>
<center><a href="<?$PHP_SELF?>?new=true">Add new host</a></center>
</td></tr>
</table>
<?
}
