...
////////////////////////////////////////////////////////////////////////////////
  ...
  if($num==0 || $ForumName==''){
    Header("Location: ../index.php?id=60&url=".urlencode($forum_url.'?'.$GetVars));
    exit;
  }
    ...
    // Log Out/Log In
      if($ForumSecurity){
        if(!empty($phorum_auth)){
          ...
          addnav($menu, $lLogIn, "login.$ext?f=$f");
        }
      }
  ...
  if(initvar("attach")){
    ...
    Header ("Location: ../../index.php?id=60&url=".urlencode("$list_page.$ext?f=$num$more$GetVars"));
  }
?>
