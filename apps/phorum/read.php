...
////////////////////////////////////////////////////////////////////////////////
// $Id: read.php,v 1.75 2001/12/11 23:17:04 ts77 Exp $
...
//////////////////////////
  ...
  //////////////////////////
    ...
    $menu=array();
    // Previous Message
    addnav($menu, $lPreviousMessage, "$read_page.$ext?$prev_link");
    // Next Message
    addnav($menu, $lNextMessage, "$read_page.$ext?$next_link");
...
<table width="<?php echo $ForumTableWidth; ?>" cellspacing="0" cellpadding="3" border="0">
<tr>
    <td valign="TOP" width=100% <?php echo bgcolor($ForumNavColor); ?>><a href="<?php echo $reply_url; ?>"><FONT color='<?php echo $ForumNavFontColor; ?>' class="PhorumNav"><?php echo $LowLeftNav; ?></font></a></td>
