    ...
    if($password!=$checkpassword){
      ...
      $Error=$lRegistrationCensor;
        ...
        if(!get_magic_quotes_gpc()){
            ...
            $safe_email=str_replace("'", "\\'", $safe_email);
            $safe_webpage=str_replace("'", "\\'", $safe_webpage);
            $safe_image=str_replace("'", "\\'", $safe_image);
            $safe_signature=str_replace("'", "\\'", $safe_signature);
            $safe_icq=str_replace("'", "\\'", $safe_icq);
            $safe_yahoo=str_replace("'", "\\'", $safe_yahoo);
            $safe_aol=str_replace("'", "\\'", $safe_aol);
            $safe_msn=str_replace("'", "\\'", $safe_msn);
            $safe_jabber=str_replace("'", "\\'", $safe_jabber);
        }
...
<tr>
    <td <?php echo bgcolor($default_nav_color); ?>>
        ...
        <tr>
            <td <?php echo bgcolor($default_table_body_color_1); ?> nowrap><font color="<?php echo $default_table_body_font_color_1; ?>">&nbsp;<img src="images/icon_icq.gif" alt="ICQ" border="0" width="16" height="16" />&nbsp;ICQ:&nbsp;&nbsp;</font></td>
            <td <?php echo bgcolor($default_table_body_color_1); ?>><input type="text" name="icq" size="50" maxlength="50" value="<?php echo $icq; ?>"></td>
        </tr>
        <tr>
            <td <?php echo bgcolor($default_table_body_color_1); ?> nowrap><font color="<?php echo $default_table_body_font_color_1; ?>">&nbsp;<img src="images/icon_aim.gif" alt="AIM" border="0" width="16" height="16" />&nbsp;AOL:&nbsp;&nbsp;</font></td>
            <td <?php echo bgcolor($default_table_body_color_1); ?>><input type="text" name="aol" size="50" maxlength="50" value="<?php echo $aol; ?>"></td>
        </tr>
        <tr>
            <td <?php echo bgcolor($default_table_body_color_1); ?> nowrap><font color="<?php echo $default_table_body_font_color_1; ?>">&nbsp;<img src="images/icon_yahoo.gif" alt="Yahoo IM" border="0" width="16" height="16" />&nbsp;Yahoo:&nbsp;&nbsp;</font></td>
            <td <?php echo bgcolor($default_table_body_color_1); ?>><input type="text" name="yahoo" size="50" maxlength="50" value="<?php echo $yahoo; ?>"></td>
        </tr>
        <tr>
            <td <?php echo bgcolor($default_table_body_color_1); ?> nowrap><font color="<?php echo $default_table_body_font_color_1; ?>">&nbsp;<img src="images/icon_msn.gif" alt="MSN" border="0" width="16" height="16" />&nbsp;MSN:&nbsp;&nbsp;</font></td>
            <td <?php echo bgcolor($default_table_body_color_1); ?>><input type="text" name="msn" size="50" maxlength="50" value="<?php echo $msn; ?>"></td>
        </tr>
        <tr>
            <td <?php echo bgcolor($default_table_body_color_1); ?> nowrap><font color="<?php echo $default_table_body_font_color_1; ?>">&nbsp;<img src="images/icon_jabber.gif" alt="Jabber" border="0" width="16" height="16" />&nbsp;Jabber:&nbsp;&nbsp;</font></td>
        ...
        <tr>
            ...
            <td <?php echo bgcolor($default_table_body_color_1); ?>><textarea class="PhorumBodyArea" onKeyDown="textlimit(this.form.signature,255);" onKeyUp="textlimit(this.form.signature,255);" cols="30" rows="6" name="signature"><?php echo $signature; ?></textarea></td>
        </tr>
        <tr>
