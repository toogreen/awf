...
<td align="left" bgcolor="#dedede" valign="top">
<?
...
<p><b><?=printf(LANG_SEND_MESSAGE,LANG_ANONYMOUS_MESSAGE)?></b><br />
<span style="font-size:10px"><?=LANG_TO?> <?=get_user_nickname($send_message)?></span>
</td>
<td align="right" bgcolor="#dedede" valign="middle">
<img src="img/32x32/actions/mail_reply.png" border="0">
</td>
</tr><tr>
<td colspan="2" align="left" bgcolor="#ffffff" valign="top"><center>
<form action="<?=$PHP_SELF?>"?>
<input type="hidden" name="send_message" value="<?=$send_message?>">
<input type="hidden" name="type" value="<?=$type?>">
<textarea wrap="virtual" name="body" cols="25" rows="10"></textarea><br />
...
?>
<p><b><?=printf(LANG_SENT_MESSAGE, LANG_ANONYMOUS_MESSAGE)?></b><br />
<span style="font-size:10px"><?=LANG_TO?> <?=get_user_nickname($send_message)?></span>
</td>
<td align="right" bgcolor="#dedede" valign="middle">
<img src="img/32x32/actions/mail_generic.png" border="0">
</td>
</tr><tr>
<td colspan="2" align="left" bgcolor="#ffffff" valign="top">
<?=stripslashes($body)?>
</p><p>
<center>[ <a href="javascript:window.close();"><?=LANG_CLOSE?></a> ]</center>
</td></tr></table>
</p>
...
<a href="<?=$PHP_SELF?>?message_id=<?=$message['message_id']?>&send_message=<?=$message['sender_id']?>&session_passwd=<?=$session_passwd?>&session_userid=<?=$session_userid?>"><?=get_user_nickname($message['sender_id'])?></a> 
...
<p><b><?=printf(LANG_SEND_MESSAGE, $type_long)?></b><br />
<?php 
...
?>
<p><b><?=printf(LANG_SENT_MESSAGE, $type_long)?></b><br />
<span style="font-size:10px"><?=LANG_TO?> <?=get_user_nickname($message['sender_id'])?></span>
</td>
<td align="right" bgcolor="#dedede" valign="middle">
<img src="img/32x32/actions/mail_generic.png" border="0">
